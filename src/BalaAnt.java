/**
 * This is the class for the Bala ant
 */
...
public class BalaAnt extends Ant
{
  //set up defaults here but allow them to be overridden via a constructor
    ...
    public BalaAnt()
    {
        this.createBalaAntStartState(DEFAULT_ANT_ID, DEFAULT_COMBAT_SKILL, DEFAULT_FOOD_CONSUMPTION_RATE, DEFAULT_AWARENESS_RADIUS,
     ...
     */
    public BalaAnt(MapSpace passedMapSpace)
    {
        this.createBalaAntStartState(DEFAULT_ANT_ID, DEFAULT_COMBAT_SKILL, DEFAULT_FOOD_CONSUMPTION_RATE, DEFAULT_AWARENESS_RADIUS,
    ...
    /**
     * Default BalaAnt Constructor
     */
    public BalaAnt(int passedAntId, double passedCombatSkill, int passedFoodConsumptionRate, int passedAwarenessRadius,
    ...
    {
        this.createBalaAntStartState(passedAntId, passedCombatSkill, passedFoodConsumptionRate, passedAwarenessRadius, 
    ...
    /**
     * Helper method to make construction of a valid Bala ant easier
     * @param passedAntId
     ...
     */
    private void createBalaAntStartState(int passedAntId, double passedCombatSkill, int passedFoodConsumptionRate, int passedAwarenessRadius,
