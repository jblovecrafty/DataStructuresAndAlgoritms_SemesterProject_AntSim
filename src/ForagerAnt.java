...
public class ForagerAnt extends Ant
{
    ...
    public ForagerAnt()
    {
        this.createForagerAntStartState(DEFAULT_ANT_ID, DEFAULT_COMBAT_SKILL, DEFAULT_FOOD_CONSUMPTION_RATE, DEFAULT_AWARENESS_RADIUS,
     ...
     */
    public ForagerAnt(MapSpace passedMapSpace)
    {
        this.createForagerAntStartState(DEFAULT_ANT_ID, DEFAULT_COMBAT_SKILL, DEFAULT_FOOD_CONSUMPTION_RATE, DEFAULT_AWARENESS_RADIUS,
    ...
    /**
     * Default ForagerAnt Constructor
     */
    public ForagerAnt(int passedAntId, double passedCombatSkill, int passedFoodConsumptionRate, int passedAwarenessRadius,
    ...
    {
        this.createForagerAntStartState(passedAntId, passedCombatSkill, passedFoodConsumptionRate, passedAwarenessRadius, 
    ...
    /**
     * Helper method to make construction of a valid Forager ant easier
     * @param passedAntId
     ...
     */
    private void createForagerAntStartState(int passedAntId, double passedCombatSkill, int passedFoodConsumptionRate, int passedAwarenessRadius,
